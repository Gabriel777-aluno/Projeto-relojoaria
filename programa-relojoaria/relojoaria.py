...
#e so demonstrativo mano, n tem problema
    ...
    label_imagem1.bind("<Button-1>", lambda event: detalhamento(nomeee[0], Descricao[0], precos[0], garantia[0], quantidade[0]))
    ...
    label_imagem2.bind("<Button-1>", lambda event: detalhamento(nomeee[1], Descricao[1], precos[1], garantia[1], quantidade[1]))
    ...
    label_imagem3.bind("<Button-1>", lambda event: detalhamento(nomeee[2], Descricao[2], precos[2], garantia[2], quantidade[2]))
    ...
    label_imagem3.bind("<Button-1>", lambda event: detalhamento(nomeee[3], Descricao[3], precos[3], garantia[3], quantidade[3]))
    ...
    label_imagem5.bind("<Button-1>", lambda event: detalhamento(nomeee[4], Descricao[4], precos[4], garantia[4], quantidade[4]))
    ...
    label_imagem6.bind("<Button-1>", lambda event: detalhamento(nomeee[5], Descricao[5], precos[5], garantia[5], quantidade[5]))
    ...
    label_imagem7.bind("<Button-1>", lambda event: detalhamento(nomeee[6], Descricao[6], precos[6], garantia[6], quantidade[6]))
    ...
    label_imagem8.bind("<Button-1>", lambda event: detalhamento(nomeee[7], Descricao[7], precos[7], garantia[7], quantidade[7]))
...
#Detalhes
#----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
def detalhamento(nomeee, Descricao, precos, garantia, quantidade):
    ...
    tk.Label(detalhe, text=nomeee, font="Montserrat 18", bg="#333333", fg="white").grid(row=1, column=0, padx=10, pady=10, sticky="w")
    tk.Label(detalhe, text=f"Descrição: {Descricao}", font="Montserrat 12", bg="#333333", fg="white").grid(row=2, column=0, padx=10, pady=10, sticky="w")
    tk.Label(detalhe, text=f"Preço: R$ {precos:.2f}", font="Montserrat 12", bg="#333333", fg="white").grid(row=3, column=0, padx=10, pady=10, sticky="w")
    tk.Label(detalhe, text=f"{garantia}", font="Montserrat 12", bg="#333333", fg="white").grid(row=4, column=0, padx=10, pady=10, sticky="w")
    tk.Label(detalhe, text=f"Quantidade disponível: {quantidade}", font="Montserrat 12", bg="#333333", fg="white").grid(row=5, column=0, padx=10, pady=10, sticky="w")
